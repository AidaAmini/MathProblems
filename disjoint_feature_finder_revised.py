...
class disjoint_feature_finder_revised:
	...
	def appropriate_feature_finder_list_log_linear(self, feature_list, np1, np2):
		np1_conjunction = self.question_prop.in_noun_phrases_in_list(self.question_prop.related_words_with_conjunction, np1)
		np2_conjunction = self.question_prop.in_noun_phrases_in_list(self.question_prop.related_words_with_conjunction, np2)
		if np1_conjunction == 1 and np2_conjunction == 1:

class file_refrence:
	...
	##################################################
	whole_question_path = 'data/problem_preprocessed/'
	whole_question_suffix = '_lemma.txt'
	question_strings_path = 'data/spilit_preprocessed/'
	...
	gold_subset_pair_paths = 'data/subset_types/'
	gold_disjoint_pair_path = 'data/disjoint_types/'
	gold_equivalence_pair_path = 'data/parallel_types/'
	...
	score_file_name_relevant_np_entity = 's_np_entity.txt'
